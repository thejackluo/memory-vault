...
async function loadConversations() {
  ...
  try {
    ...
    loadingMsg.textContent = `Error loading conversations: ${error.message}. Make sure conversations.json is in the data/ directory.`;
...
async function loadAssets() {
  ...
  try {
    ...
    if (!response.ok) {
      ...
      console.warn('Make sure assets.json is in the data/ directory');
      assetsJson = {};
      return;
    }
